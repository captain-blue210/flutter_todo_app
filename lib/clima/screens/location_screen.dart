...
import 'package:flutter_todo_app/clima/screens/city_screen.dart';
import 'package:flutter_todo_app/clima/services/weather.dart';
import 'package:flutter_todo_app/clima/utilities/constants.dart';
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    onPressed: () async {
                      ...
                      if (typedNmae != null) {
                        updateUI(await weather.getCityWeather(typedNmae));
                      }
                    },
                    child: Icon(
                      Icons.location_city,
